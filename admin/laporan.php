...
?>
	...
	<tr> 
		...
		<td bgcolor="#6666666" ><div align="center"><strong><font face="verdana" size="2" color="#FFFFFF">Jumlah Artikel : <b><? echo $jumlah; ?><br>cetak laporan<a href="#" onClick="window.open('a.php?idlap=<? echo $idlap;?>&iduser=<? echo $iduser;?>','scrollwindow','top=200,left=350,width=575,height=500');" style="text-decoration:none" title="Info Situs"><img src="./img/print.png" border="0" title="Cetak Laporan"></a>
							</font></strong></div></td>

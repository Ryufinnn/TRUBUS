	...
	<table width="74%" border="0" cellpadding="0" cellspacing="0" bordercolor="#99CC99" align="center">
	  ...
	  <tr>
	    ...
	    <ol>
          ...
          (<strong>Bank BRI, Cabang Padang, No.502.30.44314.6, a/n Septian Yamaika </strong>)          </font></li>
	      ...
	      <li><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Kemudian kirim ke alamat <strong>septian@gmail.com</strong>. dengan <em>Subject:</em><strong>Pesanan <? echo $_GET['kode'];?></strong></font></li>

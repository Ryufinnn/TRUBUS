...
<tr> 
	...
	<td width="70%" bgcolor="#6666666" ><div align="center"><strong><font face="verdana" size="2" color="#FFFFFF"><? echo $status.$user_name; ?></font></strong></div></td>
...
<tr>
	...
	<table width="165" align="center">
		...
		<a href="logout.php" style="text-decoration:none " title="Keluar" onclick="konfirmasi()"><img src="./img/guestbook.png" border="0"><b><font face="verdana" size="2" color="#FF0000">Logout</font></b></a>		</td>
		</tr>
	</table>
	</td>
	<td>&nbsp;</td>
...
<tr> 
	...
	<td bgcolor="#6666666" ><div align="center"><font face="verdana" size="2" color="#FFFFFF">Jumlah Member : <? echo $count; ?></font></div></td>

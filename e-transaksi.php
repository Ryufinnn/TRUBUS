...
?>
	...
	<table width="63%" border="0" cellpadding="0" cellspacing="0" bordercolor="#99CC99" align="center">
	  <tr>
		...
		<td width="96%" bgcolor="#666666" ><div align="center"><strong><font face="verdana" size="2" color="#FFFFFF">SHOPPING CART</font></strong></div></td>
	  ...
	  <tr>
		...
		if (!empty($cek)){
			...
			<tr bgcolor="#999999">
				...
				<th width="255"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif">JUMLAH</font></th>
			...
			?><form method="POST" action="./aksi.php?page=anggota&act=update">
			  <tr> <input type="hidden" name="id" value="<?php echo $row['idshop'];?>">
				...
				<td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> <input type="text" name="jml" value="<?php echo $jumlah;?>" size='5'></font></td>
				...
				<img src="./img/hapus.png" border="0"><font color="#666666" face="verdana" size="2">Hapus</font></a> <input type='submit' value='Ubah'>
				</td>
				</form>
			  </tr>
			 <?
	  ...
	  <tr>
		...
		<td bgcolor="#666666" ><div align="center"><strong><font face="verdana" size="3"></font></strong></div></td>
...
<tr> 
	...
	<td width="94%" bgcolor="#666666" ><div align="center"><strong><font face="verdana" size="2" color="#FFFFFF">PRODUK</font></strong></div></td>
...
<tr> 
	<td align="right"><img src="./img/kib.jpg"></td>
	<td bgcolor="#666666" ><div align="center"><strong><font face="verdana" size="2" color="#FFFFFF">Jumlah Barang : <b><? echo $jumlah; ?></font></strong></div></td>
	<td><img src="./img/kab.jpg"></td>
</tr>
</table>
<?
